...
namespace SI2021_16_RentACar
{
    ...
    {
       private readonly FirmBusiness firmBusiness;
        ...
        private void Confirmation_Load(object sender, EventArgs e)
        {
            ...
            List<Firm> firms = this.firmBusiness.GetAllFirms();
                        ...
                        if (b.Id_user == id)
                        {
                            foreach(Firm f in firms)
                            {
                                if(f.Id_firm<2)
                                {
                                    ...
                                    listBox1_confirmation.Items.Add("- Location: " + f.location);
                                    listBox1_confirmation.Items.Add("- Address: Crvene armije 40");
                                    ...
                                    listBox1_confirmation.Items.Add("- Final price: " + fp + "€");
                                    listBox1_confirmation.Items.Add("___________________________________");
                                    listBox1_confirmation.Items.Add(" ");
